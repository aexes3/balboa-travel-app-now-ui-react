      ...
      <div className="cd-section" id="features">
          ...
          <Container>
            <Row>
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">Feature 1 - Working is a pleasure</h2>
                <h4 className="description">
                All GoPro Travelers must use their designated Travel Agency when booking travel. 
                In addition to ensuring utilization of our travel partners, this enables 
                Travel and Security to contact all travelers in the event of an emergency.
                </h4>
              </Col>
            </Row>
            <Row>
              ...
              <Card
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/HwaiianLogo.png") + ")"
                  }}
                >
                  <div className="info">
                    ...
                    <div className="description">
                      ...
                      <a
                        className="ml-3"
                        href="https://www.hawaiianairlines.com/"
                        target="_blank"
          ...
          <Container fluid>
            <Row>
              <Col className="mr-auto ml-auto" md="8">
                <h2 className="title">Feature 2 - Working is a pleasure</h2>
                <h4 className="description">
          ...
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                <h2 className="title">Feature 3 - Coming home, a pleasure!</h2>
                <h4 className="description">
        ...
        <div className="features-6">
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                <h2 className="title">Feature 4 - Working is a pleasure</h2>
                <h4 className="description">
        ...
        >
          <Col className="ml-auto mr-auto text-center" md="8">
            <h2 className="title">Feature 5 - Working is a pleasure</h2>
            <h4 className="description">
