...
import Image from '../../../../assets/img/presentation-page/ihgspire.jpg';
import {
  Avatar,
  Fab,
  List,
...
export default function IhgSpire (props) {
        ...
        <CardContent className={classes.button}>
          <Typography variant="body2" color="textSecondary" >
                <List className={classes.button} >
                    ...
                    <ListItem>
                    Earn 100% Bonus Points on Top of Base Points
                    </ListItem>
                    <ListItem>
