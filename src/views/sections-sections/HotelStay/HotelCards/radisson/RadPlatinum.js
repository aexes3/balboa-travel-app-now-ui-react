...
import Image from '../../../../../assets/img/presentation-page/radiplatinum.png';
import {
  Avatar,
  Fab,
  List,
...
export default function RadPlatinum (props) {
        ...
        <CardContent className={classes.button}>
          <Typography variant="body2" color="textSecondary" >
                <List className={classes.button} >
                    ...
                    <ListItem>
                    Room availability guarantee as long as booked at least 72 hours in advance
                    </ListItem>
                    <ListItem>
                    Free breakfast
                    </ListItem>
                    <ListItem>
                    Exclusive Platinum Member Services line - available 24 hours a day, 7 days a week
                    </ListItem>
                </List>
          </Typography>
