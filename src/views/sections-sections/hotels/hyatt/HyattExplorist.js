...
import Image from '../../../../assets/img/presentation-page/hyattexplorist.png';
import {
  Avatar,
  Fab,
  List,
...
export default function HyattExplorist (props) {
        ...
        <CardContent className={classes.button}>
          <Typography variant="body2" color="textSecondary">
                <List className={classes.button}>
                    <u><b>Benefits:</b></u>
                    <ListItem>
                    Achieve status after completing 30 qualifying nights or earning 50,000 Base Points
                    </ListItem>
                    <ListItem>
