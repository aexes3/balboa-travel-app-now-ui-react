...
import Image from '../../../../../assets/img/presentation-page/ihgclub.jpg';
import {
  Avatar,
  Fab,
  List,
...
export default function IhgClub (props) {
        ...
        <CardContent className={classes.button}>
          <Typography variant="body2" color="textSecondary" >
                <List className={classes.button} >
                    ...
                    <ListItem>
                    Exclusive Rates called Your Rate
                    </ListItem>
                    <ListItem>
                    Earn Bonus Points with Your Rate
                    </ListItem>
                    <ListItem>
                    Dedicated Customer Service Phone Assistance
                    </ListItem>
                    <ListItem>
                    Complimentary Room Internet
                    </ListItem>
                    <ListItem>
                    In-Room Spa Credit
                    </ListItem>
