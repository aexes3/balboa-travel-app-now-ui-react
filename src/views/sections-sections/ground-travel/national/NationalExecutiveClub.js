...
export default function NationalExecutiveClub (props) {
        ...
        <CardContent className={classes.button}>
          <Typography variant="body2" color="textSecondary">
                <List className={classes.button}>
                    ...
                    <ListItem>
                    Qualify with 12 paid rentals or 40 paid rental days in a calendar year
                    </ListItem>
                    <ListItem>
                    Free Rental Days: Earn 1 rental credit for every qualified car rental.  <br />
                    &#176; Free rental = 6 credits
                    </ListItem>
                    <ListItem>
                    Executive Area Access: Choose any car (Fullsize and above) in the Executive 
                    Area and only pay the Midsize rate (in US and Canada)
                    </ListItem>
                    <ListItem>
                    Guaranteed Upgrades: guaranteed free upgrade from Midsize rate in US and Canada
                    </ListItem>
                    <ListItem>
