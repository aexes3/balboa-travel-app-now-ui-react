...
import Image from '../../../../assets/img/presentation-page/emgold.png';
import {
  Avatar,
  Fab,
  List,
...
export default function EmGold (props) {
              ...
              <Col>
                <List component="nav" classname="justify-content-center">
                  <ListItem  className={classes.button}>
                    <Fab href="tel:800-777-3999" rel="noopener noreferrer" size="large" color="default" variant="fab">
                      <PhoneIcon /> &nbsp; 800-777-3999
                    </Fab>
                  </ListItem>
                </List>
              </Col>
